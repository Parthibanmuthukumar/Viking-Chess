...
/**
 * Exact Cburnett / Wikipedia chess pieces — the identical set used by Lichess.
 * Paths sourced directly from: lichess-org/lila public/piece/cburnett/
 * ViewBox: 0 0 45 45
 */
export default function ChessPiece({ type, color, className = '', style }: ChessPieceProps) {
  ...
  const wP = (
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
      <path fill="#fff" strokeLinecap="butt" strokeLinejoin="miter"
        d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03C15.41 27.09 11 31.58 11 39.5H34C34 31.58 29.59 27.09 26.59 26.03 28.06 24.84 29 23.03 29 21c0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z"/>
    </g>
  );
  ...
  const pieces: Record<string, React.ReactElement | null> = {
    wp: wP, bp: bP,
    wr: wR, br: bR,
    wn: wN, bn: bN,
    wb: wB, bb: bB,
  ...
  return (
    <svg
      ...
      style={{ width: '88%', height: '88%', display: 'block', ...style }}
    >
      {piece}
    </svg>
  );
